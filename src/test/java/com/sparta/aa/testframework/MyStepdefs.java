...
//    }
//
//    @And("I enter {string} into the password box")
//    public void iEnterIntoThePasswordBox(String password) {
...
//        MatcherAssert.assertThat(loginPage.getMessageText(), Matchers.startsWith(message));
//    }
}
